...
// Assigning elements for assignment details
...
// Function to validate assignment inputs
...
function AddAssignment() {
    if (checkAssign()) {
        ...
        setTimeout(adding, 2000); // Simulate a delay for adding the assignment
        ...
        function adding() {
            ...
            window.location.assign("SeeAssignments.html"); // Redirect to See Assignments page
        }
    }
}
